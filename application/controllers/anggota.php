...
class Anggota extends OperatorController
{
	...
	public function index()
	{
		...
		$crud->columns('file_pic', 'id_anggota', 'identitas', 'nama', 'jk', 'alamat', 'kota', 'jabatan_id', 'departement', 'no_rek', 'tgl_daftar', 'aktif');
		$crud->fields('nama', 'identitas', 'jk', 'tmp_lahir', 'tgl_lahir', 'status', 'departement', 'agama', 'alamat', 'kota', 'notelp', 'tgl_daftar', 'jabatan_id', 'pass_word', 'aktif', 'file_pic', 'nama_bank', 'no_rek');

		$crud->display_as('id_anggota', 'ID');
		$crud->display_as('identitas', 'NIK');
		...
		$crud->display_as('no_rek', 'No Rekening');
		// $crud->display_as('gaji_net','Gaji Net');
		...
		// GAJI NET
		// $gaji_net_arrs = get_gaji_net();
		// $gaji_net_arr = array();
		// foreach ($gaji_net_arrs as $key => $val) {
		// 	$gaji_net_arr[$key] = $val['nama'].' | Rp '.number_format($val['nominal']);
		// }
		// $crud->field_type('gaji_net','dropdown', $gaji_net_arr);
		...
		$crud->field_type(
			...
			array(
				'' => '',
				'Poli Rawat Jalan' => 'Poli Rawat Jalan',
				'IGD' => 'IGD',
				'Instalasi Farmasi' => 'Instalasi Farmasi',
				'Instalasi Rekam Medik' => 'Instalasi Rekam Medik',
				'Instalasi Gizi' => 'Instalasi Gizi',
				'Kesling' => 'Kesling',
				'Laboratorium' => 'Laboratorium',
				'UTD' => 'UTD',
				'Instalasi Pemulasaran Jenazah' => 'Instalasi Pemulasaran Jenazah',
				'BPJS Center' => 'BPJS Center',
				'Instalasi Laundry' => 'Instalasi Laundry',
				'CSSD' => 'CSSD',
				'Endoskopi' => 'Endoskopi',
				'Ruang Vip A' => 'Ruang Vip A',
				'Ruang Vip B' => 'Ruang Vip B',
				'Isolasi/Zaitun' => 'Isolasi/Zaitun',
				'ICU' => 'ICU',
				'Kamar Operasi/OK' => 'Kamar Operasi/OK',
				'Radiologi' => 'Radiologi',
				'Zaal Bedah' => 'Zaal Bedah',
				'Zaal Dalam Atas' => 'Zaal Dalam Atas',
				'Zaal Dalam Bawah' => 'Zaal Dalam Bawah',
				'Zaal  Anak ' => 'Zaal  Anak ',
				'NICU' => 'NICU',
				'Ruang Nifas' => 'Ruang Nifas',
				'Ruang VK' => 'Ruang VK',
				'Loket' => 'Loket',
				'Kasir' => 'Kasir',
				...
				'Costing' => 'Costing',
				'Satpam' => 'Satpam',
				'Dikes Kab. Bima' => 'Dikes Kab. Bima',
				'Dikes Kota Bima' => 'Dikes Kota Bima',
				'Pensiunan' => 'Pensiunan',
				'Lain-lain' => 'Lain-lain'
			)
		);
		...
		if ($this->input->post('submit')) {
			...
			if (!$this->upload->do_upload('import_anggota')) {
				...
				foreach ($data_list_x as $data_kolom) {
					if ((@$data_kolom['A'] == NULL || trim(@$data_kolom['A'] == ''))) {
						continue;
					}
					foreach ($data_kolom as $kolom => $val) {
						if (in_array($kolom, array('E', 'K', 'L', 'P'))) {
							$val = ltrim($val, "'");
						}
