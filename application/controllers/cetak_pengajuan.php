...
class Cetak_pengajuan extends OPPController {
	...
	function laporan() {
		...
		'.$pdf->nsi_box($text = '<span class="txt_judul">Laporan Data Pengajuan <br></span> <span> Periode '.jin_date_ina($tgl_dari).' - '.jin_date_ina($tgl_sampai).' | Jenis: '.$txt_jenis.' | Status: '.$txt_status.' </span> ', $width = '100%', $spacing = '0', $padding = '1', $border = '0', $align = 'center').'
		...
		foreach ($list as $row) {
			...
			<tr nobr="true">
				...
				<td class="h_kanan">'.$row->num_ags.'</td>
