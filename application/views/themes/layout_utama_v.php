...
<head>
	<meta charset="UTF-8">
	<title><?php echo $judul_browser;?> - KPRI HUSADA</title>
...
<body class="skin-blue">
	...
	<?php
	$menu_hidden_arr = array('pengajuan','anggota'); // bisa lebih dari satu, pisah dgn koma: contoh 'pengajuan', 'lap_anggota'
	$area_side_left = '';
	$area_side_right = '';
	if(in_array($this->uri->segment(1), $menu_hidden_arr)) {
		$area_side_left = 'collapse-left';
		$area_side_right = 'strech';
	}

	?>
	<div class="wrapper row-offcanvas row-offcanvas-left">
		<!-- Left side column. contains the logo and sidebar -->
		<aside class="left-side sidebar-offcanvas <?php echo $area_side_left; ?>">                
		...
		<aside class="right-side <?php echo $area_side_right; ?>">                
