	...
	<div class="col-md-6">
		<div class="box box-solid box-primary">
			<div class="box-header with-border">
				<h3 class="box-title">Anggota Aktif Gaji Net</h3>
			</div><!-- /.box-header -->
			<div class="box-body">
				<table class="table table-bordered">
					<tbody>
						...
						$agg_arr = array();
						$total = 0;
						foreach ($anggota_gaji_net_arr as $val) {
							$agg_arr[$val->gaji_net] = $val->total;
							$total += $val->total;
						}
						$no = 1;
						foreach ($gaji_net_arr as $key => $val) {
							$persen = 0;
							$jumlah = 0;
							if(isset($agg_arr[$key])) {
								$jumlah = number_format($agg_arr[$key]);
							}
							if($total > 0) {
							...
							<tr>
								...
								<td>
									<div class="progress progress-xs">
										<div class="progress-bar progress-bar-primary" style="width: '.$persen.'%">'.$persen.'%</div>
									</div>
								</td>
