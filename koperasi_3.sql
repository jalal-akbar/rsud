...
--
-- Host: localhost
-- Generation Time: 03 Jun 2020 pada 13.58
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
('5d72fddd29e7b7294c097c60794edeef', '192.168.1.52', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36', 1578459377, ''),
('a6ab084cafe6e82c7816e9cd441a5939', '115.124.77.98', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36', 1583400118, '');
...
(32, 'F4', 'Simpanan Lebaran', 'Pasiva', 'PENDAPATAN', 'Y', 'Y', 'Y'),
...
(41, 'I2', 'Simpanan Wajib', 'Pasiva', 'PENDAPATAN', 'Y', 'Y', 'Y'),
...
(112, 'F2', 'Simpanan Sukarela', 'Pasiva', '', 'Y', 'Y', 'Y');
...
(1, 'Pinjaman Biasa', 'Uang', '-', 0, 0, ''),
(2, 'Pinjaman Darurat', 'Uang', '-', 0, 0, ''),
(3, 'Pinjaman Barang', 'Uang', '-', 0, 0, '');
...
(1, 'nama_lembaga', 'KOPERASI KARYAWAN POLYPACK'),
(2, 'nama_ketua', 'YUDI WAHYUDI SADELI'),
(3, 'hp_ketua', '08138888888'),
(4, 'alamat', 'Jl. Maju Jaya KM 11, Desa Jaya Abadi Kecamatan Cileungsi'),
(5, 'telepon', '021-89934450'),
(6, 'kota', 'BOGOR 16820'),
(7, 'email', 'kkp@gmail.com'),
(8, 'web', 'http://115.124.76.99/kkp');
...
(2, 'operator', 'ff546a1143afce9c58af2a5bf001811fe3b7699a', 'Y', 'operator'),
(3, 'pinjaman', 'efd2770f6782f7218be595baf2fc16bc7cf45143', 'Y', 'pinjaman');
...
--
CREATE TABLE IF NOT EXISTS `v_hitung_pinjaman` (
`id` bigint(20)
,`tgl_pinjam` datetime
...
ALTER TABLE `jns_akun`
 ADD PRIMARY KEY (`id`), ADD KEY `kd_aktiva` (`kd_aktiva`);
...
ALTER TABLE `tbl_anggota`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `identitas` (`identitas`);
...
ALTER TABLE `tbl_pengajuan`
 ADD PRIMARY KEY (`id`), ADD KEY `user_id` (`anggota_id`);

--
-- Indexes for table `tbl_pinjaman_d`
--
ALTER TABLE `tbl_pinjaman_d`
 ADD PRIMARY KEY (`id`), ADD KEY `kas_id` (`kas_id`), ADD KEY `user_name` (`user_name`), ADD KEY `pinjam_id` (`pinjam_id`), ADD KEY `jns_trans` (`jns_trans`);

--
-- Indexes for table `tbl_pinjaman_h`
--
ALTER TABLE `tbl_pinjaman_h`
 ADD PRIMARY KEY (`id`), ADD KEY `anggota_id` (`anggota_id`), ADD KEY `kas_id` (`kas_id`), ADD KEY `user_name` (`user_name`), ADD KEY `jns_trans` (`jns_trans`), ADD KEY `barang_id` (`barang_id`);
...
ALTER TABLE `tbl_trans_kas`
 ADD PRIMARY KEY (`id`), ADD KEY `user_name` (`user_name`), ADD KEY `dari_kas_id` (`dari_kas_id`,`untuk_kas_id`), ADD KEY `untuk_kas_id` (`untuk_kas_id`), ADD KEY `jns_trans` (`jns_trans`);

--
-- Indexes for table `tbl_trans_sp`
--
ALTER TABLE `tbl_trans_sp`
 ADD PRIMARY KEY (`id`), ADD KEY `anggota_id` (`anggota_id`), ADD KEY `jenis_id` (`jenis_id`), ADD KEY `kas_id` (`kas_id`), ADD KEY `user_name` (`user_name`);

--
-- Indexes for table `tbl_user`
--
ALTER TABLE `tbl_user`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `u_name` (`u_name`);
